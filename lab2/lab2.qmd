...
-   [ ] Palyginimas palyginant aukšto lygio požymius (angl. *similiarity search*)
-   [ ] Sukuriant vartotojo sąsają ir modelio iškvietimą per REST API.

## Užduoties įgyvendinimas

> \[!NOTE\] Rekomenduoja projektą atidaryti naudojant [RStudio](https://posit.co/products/open-source/rstudio)
